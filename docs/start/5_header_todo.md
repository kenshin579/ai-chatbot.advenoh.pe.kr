...
- [ ] 메인 페이지에서 Admin 링크 클릭 → `/admin` 이동 확인
- [ ] Admin 페이지에서 제목 클릭 → `/` 이동 확인
- [ ] 외부 링크 메뉴에서 IT Blog 클릭 → 새 탭 열림 확인
- [ ] 외부 링크 메뉴에서 Investment Blog 클릭 → 새 탭 열림 확인
- [ ] 블로그 선택 드롭다운 정상 동작 확인
- [ ] 모바일 뷰포트에서 헤더 레이아웃 확인
